...
const Way: React.FC<WayProps> = ({ leftItem, centerText, rightItem }) => {
  return (
    <div className={styles.waySection}>
      ...
      <p className={styles.info}>Bom, a escolha é sua! Mas se você deseja tomar a decisão mais inteligente, basta tocar no botão abaixo e acessar o Método Cliente 5X agora mesmo!</p>
      <Button text="SIM, QUERO TOMAR A DECISÃO INTELIGENTE AGORA" imageUrl="/image/icons-security.svg" /> 
    </div>
  );
};
